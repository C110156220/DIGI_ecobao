...
class Email:
    def __init__(self,content=None):
        ...
        # 寄信伺服器
        self.account = "redacted@example.com"
        self.password = "***REMOVED-GMAIL-APP-PASSWORD***"
    ...
    def order_complete(self,to_email=None,data):
        ...
        self.mail_info['From'] = "redacted@example.com"
    ...
    def order_send(self,to_email=None,data):
        ...
        if to_email == None :
            return(False)
        self.content['From'] = "redacted@example.com"
