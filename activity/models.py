...
class Activity(models.Model):
    ...
    pic1 = models.ImageField("首圖", upload_to=os.path.join("assets", "activity"), null=True,blank=True)
    pic2 = models.ImageField("一張", upload_to=os.path.join("assets", "activity"), null=True,blank=True)
    pic3 = models.ImageField("二張", upload_to=os.path.join("assets", "activity"), null=True,blank=True)
    pic4 = models.ImageField("三張", upload_to=os.path.join("assets", "activity"), null=True,blank=True)
